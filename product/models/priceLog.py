...
class PriceLog(models.Model):
    ...
    #owner = models.ForeignKey('user.User', on_delete=models.CASCADE, db_comment="점주 ID", db_column='owner_id')

    store = models.IntegerField(db_comment="매장 ID", db_column='store_id', null=True)
    owner = models.IntegerField(db_comment="점주 ID", db_column='owner_id', null=True)
