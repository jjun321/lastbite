...
class OrderDetailScreen extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text(
                        '주문 메뉴',
                        style: TextStyle(fontFamily: 'Sen', fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFF181C2E)),
                      ),
                    ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(myStore.name, style: const TextStyle(fontFamily: 'Sen', fontSize: 14, fontWeight: FontWeight.w700)),
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                            ...
                            style: const TextStyle(fontFamily: 'Sen', fontSize: 14, fontWeight: FontWeight.w700)
                        ),
                        const Padding(
  ...
  Widget _buildPaymentSection() {
    return Column(
      ...
      children: [
        const Text('결제 금액',
            style: TextStyle(fontFamily: 'Sen', fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF181C2E))),
        const SizedBox(height: 16),
        _buildPriceRow('정가', order.formattedOriginalPrice),
        const SizedBox(height: 8),
        _buildPriceRow('할인액', '- ${order.formattedDiscountAmount}'), // 할인액 앞에 '-' 추가 센스!
        const SizedBox(height: 12),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Divider(height: 1, color: Color(0xFFEEF2F6)),
          const SizedBox(height: 24),
          const Text('주문자 정보', style: TextStyle(fontFamily: 'Sen', fontSize: 14, fontWeight: FontWeight.w700)),
          const SizedBox(height: 16),
  ...
  Widget _buildInfoRow(String label, String value, {bool isBold = false}) {
    return Row(
      ...
      children: [
        Text(label, style: const TextStyle(fontFamily: 'Inter', fontSize: 14, color: Color(0xFF717171))),
        Text(value, style: TextStyle(fontFamily: 'Inter', fontSize: 14, fontWeight: isBold ? FontWeight.bold : FontWeight.normal, color: isBold ? Colors.black : const Color(0xFF1E1E1E))),
      ],
    );
  }
}