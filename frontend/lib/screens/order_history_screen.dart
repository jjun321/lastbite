...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(fontFamily: 'Sen', fontSize: 36, color: Colors.white, fontWeight: FontWeight.bold),
          ),
        ],
      ),
    );
  ...
  Widget _buildTabItem({required String label, required bool isSelected, required VoidCallback onTap}) {
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: isSelected ? const Color(0xFF4FA55B) : const Color(0xFFE4E4E4)),
  ...
  Widget _buildOrderList(List<Order> items) {
    return ListView.separated(
      ...
      separatorBuilder: (context, index) => const Divider(height: 32, color: Color(0xFFEEF2F6), indent: 24, endIndent: 24),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(order.orderNo, style: const TextStyle(fontFamily: 'Sen', fontSize: 14, color: Color(0xFF6B6E82), decoration: TextDecoration.underline)),
                      ],
                    ),
                    const SizedBox(height: 6),
                    Row(
                      children: [
                        Text(order.representativeName, style: const TextStyle(fontFamily: 'Sen', fontSize: 14, fontWeight: FontWeight.bold)),
                        const Padding(padding: EdgeInsets.symmetric(horizontal: 8), child: Text('|', style: TextStyle(color: Color(0xFFCACCDA)))),
                        Text(order.totalCountString, style: const TextStyle(fontFamily: 'Sen', fontSize: 12, color: Color(0xFF6B6E82))),
                        const Padding(padding: EdgeInsets.symmetric(horizontal: 8), child: Text('|', style: TextStyle(color: Color(0xFFCACCDA)))),
                        Text(order.price, style: const TextStyle(fontFamily: 'Sen', fontSize: 12, color: Color(0xFF6B6E82))),
                      ],
                    ),
                  ],
                ),
          ...
          Text('픽업 ${order.pickupTime}', style: const TextStyle(fontFamily: 'Sen', fontSize: 14, color: Color(0xFF6B6E82))),
          const SizedBox(height: 16),
  ...
  Widget _buildSingleButton(String text, VoidCallback onPressed) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          text,
          style: const TextStyle(fontFamily: 'Sen', fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white),
        ),
      ),
    );
  }
