...
import '../data/mock_data.dart'; // 데이터 파일 임포트
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              child: Container(
                                ...
                                child: const Row(
                                  ...
                                  children: [
                                    Text(
                                      '네이버지도',
                                      style: TextStyle(fontSize: 12, color: Color(0xFF32343E)),
                                    ),
                                    SizedBox(width: 4),
                                    Icon(
                                      Icons.north_east,
                    ...
                    Container(
                      ...
                      child: const Center(child: Icon(Icons.location_on, color: Color(0xFF11A94D), size: 40)),
                    ),
