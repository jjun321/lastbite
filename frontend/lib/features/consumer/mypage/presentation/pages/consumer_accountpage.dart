...
class ConsumerAccountPage extends StatefulWidget {
  const ConsumerAccountPage({super.key});

  @override
  State<ConsumerAccountPage> createState() => _ConsumerAccountPageState();
}

class _ConsumerAccountPageState extends State<ConsumerAccountPage> {
  // TODO: 백엔드 연동 후 실제 사용자 정보를 불러오도록 수정
  final _nameController = TextEditingController(text: 'user_name');
  final _emailController = TextEditingController(
    text: 'user_email(00000@hansung.ac.kr)',
  );
