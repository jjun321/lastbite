...
class OrderProdList(models.Model):
    order_id = models.ForeignKey('order.Order', on_delete=models.CASCADE, db_comment="주문 번호", db_column='order_id')
    product_id = models.ForeignKey('product.Product', on_delete=models.CASCADE, db_comment="제품 ID", db_column='product_id')
